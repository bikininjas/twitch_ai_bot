...
class GeminiHandler:
    ...
    async def process_message(self, username: str, message: str, is_owner: bool = False) -> Optional[str]:
        """
    ...
    def change_personality(self, new_personality=None, force: bool = False) -> str:
        """
